...
Alle Asset-Links in HTML tragen `?v=2026-06-10-r6`. Wenn eine neue Version
ausgerollt wird:

1. In allen HTML-Dateien `2026-06-10-r6` durch neue Version ersetzen
   (z. B. `2026-01-15-r2`).
...
- **Cache-Buster** `2026-06-10-r6` synchron in allen Files; bei
